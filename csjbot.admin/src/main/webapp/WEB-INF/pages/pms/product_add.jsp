...
<head>
    ...
    <script src="${path}/scripts/pms/product_add.js"></script>
						...
						<div class="panel-heading">
							<table style="width: 99%;">
								<tr>
									...
									<td class="panel-title" style="width: 96%;text-align: center;font-weight:bold">新增产品</td>
								</tr>
							</table>
						</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													<div class="input-group">
														...
														<input class="form-control" type="text" id="name" name="name" maxlength="25" placeholder="请输入产品名称"/>
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<div class="input-group">
														<div class="input-group-addon">价格(单位:元)</div>
                                              		    <input  class="form-control" type="text" id="price" name="price"  maxlength="14" placeholder="请输入价格"/> 
													</div>
												</div>
											</div>
										</div>
