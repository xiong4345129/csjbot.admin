...
<head>
    ...
    <script src="${path }/scripts/scs/acce_list.js" ></script>
</head>  
                    ...
                    <div class="panel panel-default">
		                 <div class="panel-heading panel-title">
		                      <table style="width: 100%;">
	                            <tr>
	                                <td style="width: 15%;text-align: left;">附件管理</td>
	                                <td style="width: 10%;text-align: right;">
	                                       <a type="button" class="btn btn-primary" href="${path}/acce/toAcceAdd">新增附件</a>
	                                </td>
	                            </tr>
		                      </table>		                 
		                 </div>
