                ...
                <div class="row" style="margin-top:5px;">
                    <div class="col-xs-12">
                        <table id="file-list-table"
                            ...
                            <tbody>
                            <c:forEach items="${pkgFile}" var="file" varStatus="loop">
                                <fmt:formatDate value="${file.uploadTime}" pattern="yyyy-MM-dd HH:mm:ss" var="fmtUploadTime" />
                                <tr data-fileId="${file.id}">
                                    ...
                                    <td>${fmtUploadTime}</td>
                                    <td>
                                        <a href="http://120.27.233.57:8001${file.path}" target="_blank">查看</a>
                                        <a href="http://120.27.233.57:8001${file.path}/${file.name}" target="_blank">下载</a>
                                        <a href="#">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
